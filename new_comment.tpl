...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" id="Table_01" style="background:#fff;width:680px;border:1px solid #dbe1e6;color:#5e5e5e">
		<tbody>
			...
			<tr>
				<td style="background-color:#fff;padding:15px 15px 5px 15px"><font face="arial" style="color:#000;font-size:14px;line-height:22px;text-align:left;padding:0;display:block;text-transform:uppercase">Dear User,</font></td>
			</tr>
			<tr>
				<td style="background-color:#fff;padding:5px 15px 15px 15px"><font face="arial" style="color:#000;font-size:14px;line-height:22px;text-align:left;padding:0;display:block">You&#39;ve new comment from {{ .userName }} </font></td>
			</tr>
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" style="width:100%;border:1px solid #dbe1e6">
					<tbody>
						<tr>
							...
							<td style="width:80%;padding:10px 10px 10px 10px;background:#fff"><font face="arial" style="color:#5e5e5e;font-size:14px;line-height:22px;text-align:left;padding:0;display:block">{{ .title }} </font></td>
						</tr>
						<tr>
			...
			<tr>
				...
				You are receiving this because you are subscribed to this thread. </font>
